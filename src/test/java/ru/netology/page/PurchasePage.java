...
public class PurchasePage {
    ...
    //У любого элемента с текстом "Номер карты", родитель должен иметь на любой глубине вложения поле input:
    private final SelenideElement cardNumberField = $x("//*[text()='Номер карты']/..//input");
    private final SelenideElement cardNumberFieldError = $x("//*[text()='Номер карты']/..//*[@class='input__sub']");
    private final SelenideElement monthField = $x("//*[text()='Месяц']/..//input");
    private final SelenideElement monthFieldError = $x("//*[text()='Месяц']/..//*[@class='input__sub']");
    private final SelenideElement yearField = $x("//*[text()='Год']/..//input");
